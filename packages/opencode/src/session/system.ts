      ...
      environment: Effect.fn("SystemPrompt.environment")(function* (model: Provider.Model) {
        ...
        return [
          ...
          [
            ...
            "- The Resources workspace tab is a CLI-resources dashboard with sections: System (CT100/Mac CPU/RAM/storage), OpenCode Providers, Codex (Codex Multi-Auth), Claude Code, and Antigravity (agy). Use the cli_resources tool (action=status or probe-<section>) for a redacted read-only snapshot; it never returns auth.json/~/.claude.json/keyring/token/env values. Codex account mutations stay in account_status; Claude/Antigravity run actions are approval-gated in the UI. @codex / @accounts / @multi_auth focus the Codex section, @claude_code and @antigravity focus those sections; panel://accounts is an alias of panel://resources.",
          ].join("\n"),
          references.length === 0
            ? undefined
            : [
